...
export default class Xku extends Component {
    constructor(props) {
        super(props);
        this.state = {
            hidden: true,
            ToggleOnElectric: "1",//低压开为1，低压关为0
            HeightToggleOnElectric:'2',//开高压为2，关高压为4
            ToggleOnExtension: "10", //发射开为10，发射关为20
            Ebgcolor: '',
            Pbgcolor: '',
            Tbgcolor: '',
            ...
            transmitterLife:true,//设置发射机寿命弹窗,
            Rgcolor: '',
    ...
    handleToggleClickElectric = (e) => {
        ...
        axios({
            method: 'post',
            url: "http://localhost:8080/gTControlCodeXku",
   ...
   //开高压
    handleToggleClickExtensionHeight=()=>{
        axios({
            method: 'post',
            url: "http://localhost:8080/gTControlCodeXku",
            // headers: { 'content-type': 'application/x-www-form-urlencoded' },
            params: { pSwitch: this.state.HeightToggleOnElectric }
        }
        ).then((res) => {
            let extension = this.state.HeightToggleOnElectric;
            if (res.data === "0") {
                (extension === "2") ? this.setState({
                    HeightToggleOnElectric: "4",
                    Tbgcolor: '#141f3e'
                }) : this.setState({
                    HeightToggleOnElectric: "2",
                    Tbgcolor: ''
                });
    ...
    // 关闭发射机寿命弹窗
    closeWinodowTransmitter=(e)=>{
         this.setState({
             transmitterLife:true
         })
    }
    //关闭弹窗事件
    closeWinodow = (e) => {
    ...
    onKeyDown(keyName, e, handle){
        ...
        this.setState({
            transmitterLife:false
        })
        console.log(this.state.transmitterLife+"222222222222")
    }
    onKeyUp(){
    ...
    render() {
        ...
        return (
            ...
            <Fragment>
                <Hotkeys
                    keyName="Shift+Ctrl+Alt+F6"
                    onKeyDown={this.onKeyDown.bind(this)}
                    onKeyUp={this.onKeyUp.bind(this)}
                    >
                <div className={styles.ToolCol}>
                    <div className={styles.ToolButton}  style={{width:'305px'}}>
                        {/* 开电源 */}
                        <div
                        ...
                        >
                            <div className={styles.menuImag} style={{ background: this.state.Ebgcolor }}>
                                ...
                                <div className={styles.Image_Power} >
                                    <span className={styles.Power}> {this.state.ToggleOnElectric === '1' ? '低压开' : '低压关'}</span>
                                </div>
                        ...
                        <div
                            ...
                            onClick={this.handleToggleClickExtensionHeight}//点击事件
                        ...
                        >
                            <div className={styles.menuImag} style={{ background: this.state.Tbgcolor }}>
                                ...
                                <div className={styles.Image_Power} >
                                    <span className={styles.Power}> {this.state.ToggleOnElectric === '1' ? '高压开' : '高压关'}</span>
                                </div>
                ...
                <div className={style.Layout_Content}>
                    ...
                    <RaderXkuLayoutSide transmitterLife={this.state.transmitterLife} closeWinodowTransmitter={this.closeWinodowTransmitter} />
                ...
                <Draggable handle="strong" {...dragHandlers}>
                    <div hidden={this.props.hidden} className={styles.PowerAdjustmentWindow}>
                        ...
                        <div className={styles.content} style={{ height: '65px' }}>
                            <div className={style.radiobutton_position} style={{ paddingLeft: '10px' }}>
                                <input type='radio' name="radiobutton" onClick={this.SelectTupleChange} value="4" />全阵<br />

                            </div>

                            <div className={style.custom} style={{ height: '38px' }}>
                                <input type='radio' name="radiobutton" onClick={this.SelectTupleChange} value="0" />半阵
    {/* 显示16组阵元组 */}
