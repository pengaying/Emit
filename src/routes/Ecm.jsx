...
export default class Ecm extends Component {
    constructor(props) {
        super(props);
        this.state = {
            hidden: true,
...
class PowerAdjustmentWindow extends Component {
            ...
            <div>
                <Draggable handle="strong" {...dragHandlers}>
                    <div hidden={this.props.hidden} className={styles.PowerAdjustmentWindow}>
                        ...
                        <div className={styles.content} style={{height:'65px',paddingLeft:'50px'}}>
                            <div className={style.radiobutton_positionAll} style={{float:null}}>
                                <input type='radio' name="radiobutton" onClick={this.SelectTupleChange} value="4" />全阵<br />
                    
                            </div>

                            <div className={style.customHalf} style={{height:'38px' , float:null}}>
                                <input type='radio' name="radiobutton" onClick={this.SelectTupleChange} value="2" />半阵
    ...
    handleClickPost = (e) => {
        ...
        ///其他模式
            ...
            axios({
                method: 'post',
                url: "http://localhost:8080/gTControlECM",
                headers: { 'content-type': 'application/x-www-form-urlencoded' },
                params: {
                    pAdjustment: custom,
                }
