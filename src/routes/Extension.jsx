...
export default class Exteension extends Component {
    constructor(props) {
        super(props);
        this.state = {
            hidden: true,
                        ...
                        >
                            ...
                            >
                                ...
                                <div className={styles.Image_Power} style={{ background: this.state.Pbgcolor }}>
                                    <span className={styles.Power}>功率调整</span>
                                </div>
                            </div>
    ...
    renderArrayTuple() {
        return (
            <div className={style.ArrayTuple}>
                <input id='checkbox8' type="checkbox" name="checkbox" value="8" onClick={this.handleClickSelectTuple8} />阵元组8 &nbsp;阵元组9<br />
                <input id='checkbox7' type="checkbox" name="checkbox" value="7" onClick={this.handleClickSelectTuple7} />阵元组7 &nbsp;阵元组10<br />
                <input id='checkbox6' type="checkbox" name="checkbox" value="6" onClick={this.handleClickSelectTuple6} />阵元组6 &nbsp;阵元组11<br />
                <input id='checkbox5' type="checkbox" name="checkbox" value="5" onClick={this.handleClickSelectTuple5} />阵元组5 &nbsp;阵元组12<br />
                <input id='checkbox4' type="checkbox" name="checkbox" value="4" onClick={this.handleClickSelectTuple4} />阵元组4 &nbsp;阵元组13<br />
                <input id='checkbox3' type="checkbox" name="checkbox" value="3" onClick={this.handleClickSelectTuple3} />阵元组3 &nbsp;阵元组14 <br />
                <input id='checkbox2' type="checkbox" name="checkbox" value="2" onClick={this.handleClickSelectTuple2} />阵元组2 &nbsp;阵元组15<br />
                <input id='checkbox1' type="checkbox" name="checkbox" value="1" onClick={this.handleClickSelectTuple1} />阵元组1 &nbsp;阵元组16
            </div>
        )
    }
