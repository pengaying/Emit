...
export default class MillimeterWaveStateWindow extends Component {
    constructor(props) {
        super(props);
        this.state = {
         childhidden:true
    ...
    //调用父组件关闭按钮方法
    handleBtnCloseClicke = (e) => {
        this.props.heightStatecloseWinodow();
    }
    closeWinodow=()=>{
         this.setState({
             childhidden:true
    ...
    render() {
        ...
        return (
            ...
            <Fragment>
                <Draggable handle="strong" {...dragHandlers}>
                    <div hidden={this.props.heightState} className={styles.Light_Hundred}>
                        <strong >
                        <div className={styless.PopUpWindow_title}>
                                <span>功放 (高频)</span>
                                {/* <div style={{ diaplay: 'inline-block', float: 'right', margin: '0px 10px' }} onClick={this.handleBtnCloseClicke}> */}
