...
export default class ThreeMillimeterOneStateWindow extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    render() {
        ...
        // console.log('1111111111',this.props.socketio.data[1][popName].standingWaveProtection)
        ...
        return (
            ...
            <>
                <Draggable handle="strong" {...dragHandlers}>
                    <div hidden={this.props.hidden} className={styles.Single_ExtensionMillimeter}>
                        <strong >
                        ...
                        <div className={styles.connectThreeMillimeter}>

                        <div className={styles.Three_State}>
                            <img src={lights[0]} className={styles.LightImage} alt='图片' />
                            <br />
                            <span className={styles.Three_State_LightSpan}>电压</span>
                        </div>
                        <div className={styles.Three_State}>
                            <img src={lights[1]} className={styles.LightImage} alt='图片' />
                            <br />
                            <span className={styles.Three_State_LightSpan}>电流</span>
                        </div>
                        <div className={styles.Three_State}>
                        ...
                        <div className={styles.Three_State}>
                            ...
                            <br />
                            <span className={styles.Three_State_LightSpan}>温度</span>
                        </div>
