...
export default class ECMLayoutSide extends Component {
  constructor() {
    super()
    this.state = {
      side: null,
  ...
  render() {
    ...
    switch (side) {
      // 电源弹窗
      case 'Electric':
        component = <ECM_ElectricSourceWindow closeWinodow={this.closeWinodow} hidden={this.state.hidden} />;
        break;
      // 功率弹窗
      case 'Power':
        component = <ECM_PowerWindow closeWinodow={this.closeWinodow} hidden={this.state.hidden} />;
        break;
      // 功放弹窗
      case 'State':
        component = <ECM_StateWindow closeWinodow={this.closeWinodow} hidden={this.state.hidden} />;
        break;
      default:
        break;
    }
