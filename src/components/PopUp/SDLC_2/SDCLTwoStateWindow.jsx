...
import ThreeSDCLTwoStateWindow from './ThreeSDCLTwoStateWindow'
...
export default class SDLCTwoStateWindow extends Component {
    constructor(props) {
        super(props);
        this.state = {
            childSide: null,
    ...
    render() {
        ...
        for (let i = 0; i < nSize.length; i++) {
            ...
            while (nSize[i] === childSide) {
                component = <ThreeSDCLTwoStateWindow popUp={childSide} closeWinodow={this.closeWinodow} hidden={this.state.hidden} />;
                break;
            }
        }
        ...
        return (
            ...
            <Fragment>
                <Draggable handle="strong" {...dragHandlers}>
                    <div hidden={this.props.hidden} className={styles.light} style={{marginRight:'-20px'}}>
                        <strong >
