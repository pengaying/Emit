import RadarSCSingelStateWindow from './Radar_SC/RadarSCSingelStateWindow';
...
export default class ScLayoutSide extends Component {
  constructor() {
    super()
    this.state = {
      side: null,
  ...
  render() {
    ...
    return (
      <div className={styles.Layout_Content}>
        ...
        <div className={styles.LayoutSide} style={{height:'390px'}}>
        <strong>
          ...
          <div style={field}>
              {/* 发射机 */}
              <div style={fieldTitle}>发射机 (S波段)</div>
              <div style={fieldContent}>
              <div className={styles.ButtonImages}>
          ...
          <div style={field}>
              {/* 发射机 */}
              <div style={fieldTitle}>发射机 (C波段)</div>
              <div style={fieldContent}>
              <div className={styles.ButtonImages}>
                <img src={light} onDoubleClick={this.handleClick} id='Electric' className={styles.Image} alt='图片' />
                <span className={styles.span_section}>电源</span>
