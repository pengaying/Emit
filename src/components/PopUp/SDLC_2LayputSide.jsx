...
import SDLCTwoStateWindow from './SDLC_2/SDCLTwoStateWindow';
...
export default class SDLC_2LayoutSide extends Component {
  constructor() {
    super()
    this.state = {
      side: null,
  ...
  render() {
    ...
    switch (side) {
      // 电源弹窗
      case 'Electric':
        component = <SDCLTwoElectricSourceWindow closeWinodow={this.closeWinodow} hidden={this.state.hidden} />;
        break;
      // 功率弹窗
      case 'Power':
        component = <SDCLTwoPowerWindow closeWinodow={this.closeWinodow} hidden={this.state.hidden} />;
        break;
      // 功放弹窗
      case 'State':
        component = <SDLCTwoStateWindow closeWinodow={this.closeWinodow} hidden={this.state.hidden} />;
        break;
      default:
        break;
    }
